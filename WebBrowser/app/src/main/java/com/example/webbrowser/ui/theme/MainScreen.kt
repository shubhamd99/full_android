package com.example.webbrowser.ui.theme
...
fun MainScreen() {
    ...
    val navigator = rememberWebViewNavigator() // Navigate between our webpages
    var textFieldValue by remember(state.content.getCurrentUrl()) { // Navigate Text Field
